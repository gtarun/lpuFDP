                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="ico-tshirt mr5"></i>Feed Back</h3>
                            </div>
                            <!--/ panel heading/header -->
                            <!-- START Form Wizard -->
...
<div class="panel-body">
									<div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                        <?php echo $form->textField($model,'company_name',array('class'=>'form-control','data-parsley-group'=>"order",'data-parsley-required'=>'data-parsley-required')); ?>
                                        </div>
                                    </div>


                                  <div class="form-group">
                                        <label class="col-sm-4 control-label">How would you rate communication experience?<br /> 5 - Excellent, 3 - Satisfactory, 1 - Poor Experience <span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                     ...
                                     <div class="form-group">
                                        <label class="col-sm-4 control-label">How would you rate skills experience?<br /> 5 - Excellent, 3 - Satisfactory, 1 - Poor Experience<span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                            <div class="col-sm-9 mt5">
                                            <span class="radio-inline custom-radio custom-radio-primary">
                                ...
                                <label for="customradio15">&nbsp;&nbsp;1</label>
                                     ...
                                     <div class="form-group">
                                        <label class="col-sm-4 control-label">How would you rate timelines experience?<br /> 5 - Excellent, 3 - Satisfactory, 1 - Poor Experience<span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                            <div class="col-sm-9 mt5">
                                            <span class="radio-inline custom-radio custom-radio-primary">
                               ...
                               <div class="form-group">
                                        <label class="col-sm-4 control-label">How would you rate independence experience?<br /> 5 - Excellent, 3 - Satisfactory, 1 - Poor Experience<span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
                                            <div class="col-sm-9 mt5">
                                            <span class="radio-inline custom-radio custom-radio-primary">
                                ...
                                <div class="wizard-container">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Where could the service provider improve? <span class="text-danger">*</span></label>
                                        <div class="col-sm-8">
...
<div class="mess_popup_container">
    ...
    <div class="alert_head "><h4 class="pa15 mt0">Reference Saved</h4></div>
