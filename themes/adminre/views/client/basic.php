         ...
         <div class="panel panel-default form-horizontal form-bordered">
                ...
                <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                            <?php echo $form->textField($project,'name',array('placeholder'=>"Project name",'class'=>'form-control required','data-parsley-id'=>'123')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                            	<?php echo $form->textField($project,'start_date',array('value'=>(isset($project->start_date))?date('m/d/Y',strtotime($project->start_date)):'','placeholder'=>"Select a date",'id'=>'satnamDate','class'=>'form-control required','data-parsley-id'=>'124')); ?>
                                    ...
                                    <small class="help-block">This helps service providers get a sense of your requirements against their capacity.
</small>
                            </div>
                        </div>
                       ...
                       <div class="form-group" style="background: beige">
                            ...
                            <div class="col-sm-6">
                            	<small class="help-block">
                                                Your IP's security is our utmost priority. Please note the following in this regard:
                                                <ul>
...
<!--                                <div style="height: auto;" class="col-sm-8 pa10"></div>-->
                                ...
                                <div style="height: auto;" id="regions" class="col-sm-12 panel-collapse collapse <?php echo ($project->preferences=='regoin')?'in':'';?> pl0 pr0">
                                        <div class="panel-body mt15 pl0 satnamAction">
                                             <?php
                ...
                <div class="form-group">
                    <div class="col-md-12 mt15">
                            ...
                            <div novalidate action="" data-parsley-validate="" class="panel panel-default mt10">
                                ...
                                <div id="satnamBugdet">
                             	   <?php $this->renderPartial('_budget', array('list'=>$list,'sel'=>$selecetedTier,'preference'=>$project->preferences,'city'=>$project->clientProfiles->cities->name));?>
                                </div>
...
<?php echo $form->radioButtonList($project,'custom_budget_range', array('Personal funds'=>'&nbsp;&nbsp;Personal funds', 'Cash flow from operations'=>' &nbsp;&nbsp;Cash flow from operations','Funding: Series A or up'=>'&nbsp;&nbsp;Funding: Series A or up','Funding: Seed or Angel'=>'&nbsp;&nbsp;Funding: Seed or Angel'), array('template'=>'<span class="radio-inline custom-radio custom-radio-primary">{input} {label}</span>', 'labelOptions'=>array('style'=>'display:inline'), 'separator'=>'', 'encode'=>true)); ?>
                ...
                <div class="panel-footer">
                    	<button class="btn btn-teal pull-right ml10" id="productScopeSave" type="button">Save & Next</button>
...
<section class="container-fluid hide" id="budgetProject">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                                            <small class="help-block">You can ask service providers questions to gauge their experience specific to your needs. </small>
                                            </div>
                    ...
                    <div class="col-sm-3"></div>
                        ...
                        <div class="panel-footer">
							<button class="btn btn-teal pull-right ml10 " id="btnarchive" type="button">Submit</button>
							<button class="btn btn-default pull-right " id="budgetBack" type="button">Back</button>
                        </div>
                      </div>
                    </div>
                </div>
...
$("#btnarchive").on("click", function (event) {
	...
	if(!validate('basicProject') && !validate('productScope') && !validate('budgetProject') && specialVal()){
		bootbox.dialog({
		 ...
		 bootbox.confirm("Some fields of your form are not filled. Please complete your Proejct Scope", function (result) {	return true;});
	 }
	return false;
