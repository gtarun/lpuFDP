        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="alert alert-danger">
                    ...
                    <p><strong> The service provider is seeking clarification before making an offical pitch.</strong> Please chat with the service provider to resolve the doubts.</p>
                </div>
            </div>
            <?php } ?>
        	<!--   chatting -->
							...
							<div class="panel col-xs-8">
								<div class="panel-body text-center">
									...
									<ul class="nav nav-section nav-justified">
										...
										<li>
											<div class="section">
												<h4 class="bold text-success mt0 mb5 " style="font-size:14px;" id="sartdateview">
                                                    <?php echo ($project->status == 1)?'- - -':date( "d-M-Y",strtotime($project->start_date)); ?></h4>
												<p class="nm text-muted">
										...
										<li>
											<div class="section">
												<h4 class="bold text-warning mt0 mb5" style="font-size:14px;" id="time_estimation"><?php echo ($project->status == 1)?'- - -':$project->time_estimation; ?> Days</h4>
												<p class="nm text-muted">
										...
										<li>
											<div class="section">
												<h4 class="bold text-danger mt0 mb5 " style="font-size:14px;" id="trialview">
                                                    <?php echo ($project->status == 1)?'- - -': $project->trial_period; ?> Days</h4>
												<p class="nm text-muted">
							...
							<div class="panel-body pl0 pr0 pt0 pb0" style="border:none">
								...
								<div class="col-sm-12 pl0 pr0">
									...
									<div class="col-lg-12 pl0 pr0">
										...
										<!-- Questions  list -->
										<div class="panel-group" id="accordion1" style="border:none;">
											<!-- Default question 1-->
											<div class="panel panel-default mt0" style="border:none; border-bottom:1px solid #ccc; border-radius: 0px!important;">
												...
												<div id="c1" class="panel-collapse collapse in ">
													<div class="panel-body " style="font-size:11px;  ">
														<?php echo ($project->status == 1)?'Awaiting response':((empty($project->default_q1_ans)?"Awaiting response":$project->default_q1_ans)); ?>
													</div>
												</div>
												<!-- Answer-->
											...
											<div class="panel panel-default mt0" style="border:none; border-bottom:1px solid #ccc; border-radius: 0px!important;">
												...
												<div id="c2" class="panel-collapse collapse in">
													<div class="panel-body" style="font-size:11px;">
														<?php echo ($project->status == 1)?'Awaiting response':((empty($project->default_q2_ans)?"Awaiting response":$project->default_q2_ans)); ?>
													</div>
												</div>
												<!--/ answer -->
											</div>
								...
								<div class="content-attachment pa10">
									...
									<table class="table-striped" id="attachmentView">
										...
										<tr class="doc_<?php echo $doc->id ?>">
											...
											<td width="6%">
												<a href="javascript:OpenFile('<?php echo $doc->path; ?>',500,600)" class="btn btn-link " title="Download" target="_blank">View</a>
							...
							<div class="panel-body pl0 pr0 pt0 pb0 " style="border:none">
								...
								<div class="col-sm-12 pl0 pr0">
									...
									<div class="col-lg-12 pl0 pr0 ">
										...
										<div class="panel-group panel-group-compact" id="accordion4" style="border:none; border-right:1px solid #ccc;">
											<?php echo $cqAll; ?>
										</div>
