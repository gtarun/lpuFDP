                                ...
                                <li>
                                    <div class="section">
                                        ...
                                        <p class="nm text-muted">
                                            <span class="semibold" style="font-size:12x;">Monthly Budget <i class="ico-info-sign" data-trigger="hover" data-toggle="popover" data-placement="top" data-content="Enter Text for Budget details"  style="cursor:pointer;"></i></span>
                                    </div>
                                </li>
                                <li>
                                    <div class="section">
