        ...
        <section class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h3 class="title light text-grey5 mtb22">To scope out your job, either...</h3>
                </div>
            </div>
...
<script id="my1">var ownButton = new timelyButton("venturepact", { buttonId: "my1", imgSrc: "<?php echo Yii::app()->theme->baseUrl; ?>/image/book-now-grey.png" });</script>
                    </div>
                </div>
	...
	<div class="form-group mb10">
		...
		<div class="row">
			<div class="col-sm-6 mb5">
				...
				<div class="has-icon pull-right">
					<?php echo $form->textField($users,'display_name',array('placeholder'=>"John",'class'=>'form-control required','required'=>'required','data-parsley-type'=>"alphanum",'data-parsley-minlength'=>"2"));?>
				</div>
			</div>
			<div class="col-sm-6 mb5">
				<label class="control-label">Last Name <span class="text-danger">*</span></label>
				<div class="has-icon pull-right">
					<?php echo $form->textField($users,'role',array('placeholder'=>"Doe",'class'=>'form-control required','required'=>'required','data-parsley-type'=>"alphanum",'data-parsley-minlength'=>"2"));?>
				</div>
			</div>
		</div>
	</div>
<div class="form-group mb10">
        <div class="row">
            <div class="col-sm-6 mb5">
                <label class="control-label">E-mail <span class="text-danger">*</span></label>
                <div class="has-icon pull-right">
                    <?php echo $form->textField($users,'username',array('placeholder'=>"Username / email",'class'=>'form-control required email','required'=>'required','data-parsley-type'=>"email")); ?>
            ...
            <div class="col-sm-6 mb5">
                <label class="control-label">Password <span class="text-danger">*</span></label>
                <div class="has-icon pull-right">
                     <?php echo $form->passwordField($users,'password',array('placeholder'=>"Password",'class'=>'form-control required minlength','required'=>'required','length'=>"6"));?>
	...
	<div class="form-group mb10">
		<div class="row">
			<div class="col-sm-6 mb5">
                ...
                <div class="has-icon pull-right">
               <?php echo $form->textField($users,'company_name',array('placeholder'=>"XYZ, LLC",'class'=>'form-control','data-parsley-type'=>"alphanum",'data-parsley-minlength'=>"2"));?>
<!--

                <?php echo $form->textField($users,'company_name',array('placeholder'=>"XYZ, LLC",'class'=>'form-control required','required'=>'required','data-parsley-type'=>"alphanum",'data-parsley-minlength'=>"2"));?>-->
                </div>
            </div>
            <div class="col-sm-6 mb5">
                <label class="control-label">Company Website<span class="text-danger"></span></label>
                <div class="has-icon pull-right">
                <?php echo $form->textField($users,'company_link',array('placeholder'=>"http://www.XYZ.com",'class'=>'form-control url','data-parsley-type'=>"url",'data-parsley-minlength'=>"2"));?>
                </div>
            </div>
        </div>
    </div>
    ...
    <input type="radio" data-parsley-id="5322" data-parsley-multiple="a" name="ClientProjects[team_size]" id="customradio1" value="1-2" checked="checked" />
    ...
    <input type="radio" data-parsley-id="4433" data-parsley-multiple="a" value="3-5" name="ClientProjects[team_size]" id="customradio2" <?php echo ($users->company_size=="3-5")?'checked="checked"':'';?>>
    ...
    <span class="radio-inline custom-radio custom-radio-primary spacing_left">
    <input type="radio" data-parsley-id="2947" data-parsley-multiple="a" value="11-50" name="ClientProjects[team_size]" id="customradio4" <?php echo ($users->company_size=="11-50")?'checked="checked"':'';?> />
    <label for="customradio4">&nbsp;&nbsp;11-50</label>
    </span><ul class="parsley-errors-list" id="parsley-id-multiple-a"></ul>
    <ul id="parsley-id-multiple-a" class="parsley-errors-list">
    </ul>
    <span class="radio-inline custom-radio custom-radio-primary spacing_left">
    <input type="radio" data-parsley-id="4823" data-parsley-multiple="a" value="51-100" name="ClientProjects[team_size]" id="customradio5" <?php echo ($users->company_size=="51-100")?'checked="checked"':'';?>>
    <label for="customradio5">&nbsp;&nbsp;51-500</label>
    </span><ul class="parsley-errors-list" id="parsley-id-multiple-a"></ul>
    <ul id="parsley-id-multiple-a" class="parsley-errors-list">
    </ul>
    <span class="radio-inline custom-radio custom-radio-primary">
    <input type="radio" data-parsley-id="1739" data-parsley-multiple="a" value="500+" name="ClientProjects[team_size]" id="customradio7" <?php echo ($users->company_size=="500+")?'checked="checked"':'';?>>
    ...
    <div class="form-group mb10">
        <div class="row">
            <div class="col-sm-6 mb5">
                ...
                <div class="has-icon pull-right">
                    <?php echo CHtml::dropDownList('ClientProjects[country]','',CHtml::listData(States::model()->findAll(array('condition'=>'status = 1','order'=>'name ASC')),'id', 'name'),array('class'=>"form-control required pr10",'prompt' =>'Select Country','id'=>"satnam",'ajax'=>array(
'type'=>'POST',
...
/*End of code for city and country*/
            ...
            <div class="col-sm-6 mb5">
                ...
                <div class="has-icon pull-right">
                    <?php echo CHtml::dropDownList('ClientProjects[cities_id]','',CHtml::listData(Cities::model()->findAllByAttributes(array('id'=>1)),'id', 'name'),array('class'=>"form-control required pr10",'prompt' =>'Select City','id'=>"sandeep"));?>
				</div>
			</div>
		</div>
	</div>
...
<?php echo CHtml::button('Sign Up',array('id'=>'signupButSat','class'=>'btn btn-teal')); ?>
</div>
<?php $this->endWidget(); ?>
</div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
