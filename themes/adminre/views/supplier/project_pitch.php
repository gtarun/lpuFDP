                ...
                <div class="info bottom">
                    ...
                    <div class="col-md-2 pull-right">
                        ...
                        <div class="col-md-7 mt10 ">
                            <a class="btn btn-success" data-status="1" id="btnsubmitproject" href="<?php echo CController::createUrl('/supplier/projectStatusHandler&stat=2&projectid='.$project->id); ?>" onclick="return false;">
                                <i class="ico-checkmark3 mr5"></i> Submit Project</a>
                        </div>
							...
							<div class="panel col-xs-8">
								<div class="panel-body text-center">
									...
									<a data-target="#pricetop" data-toggle="modal" class="pull-right text-primary pr10 pt5" href="" title="Edit" data-backdrop="static">
										<i class="ico-edit" style="font-size:12px;  "></i>
									</a>
									<?php } ?>
										...
										<li>
											<div class="section">
												...
												<p class="nm text-muted semibold">
													<span id="time_view">Price </span>, to be paid
													<span class="semibold" style="font-size:12x;" id="budget_type"></span>
												</p>
                                                    <?php }else{ ?>
												<p class="nm text-muted">
													<span id="time_view"> <?php echo $project->time_material; ?></span>, to be paid <span class="semibold" style="font-size:12x;" id="budget_type"><?php echo $project->billing_schedule; ?> </span>
				...
				<div class="row">
					...
					<div class="col-lg-6">
											...
											<div class="panel panel-default mt0" style="border:none; border-bottom:1px solid #ccc; border-radius: 0px!important;">
												...
												<div id="c2" class="panel-collapse collapse in ">
													<div class="panel-body" style="font-size:11px;  ">
														<?php echo (empty($project->default_q1_ans)?"Supplier didn't answer this question yet!":$project->default_q1_ans ); ?>
													</div>
												</div>
												<!-- Answer-->
												<!-- question -->
												...
												<div id="c1" class="panel-collapse collapse in ">
													<div class="panel-body" style="font-size:11px;  ">
														<?php echo (empty($project->default_q2_ans)?"Supplier didn't answer this question yet!":$project->default_q2_ans ); ?>
													</div>
												</div>
												<!-- Answer-->
								...
								<div class="content-attachment pa10">
									...
									<table class="table-striped" id="attachmentView">
										...
										<tr class="doc_<?php echo $doc->id ?>">
											...
											<td width="6%">
												<a href="<?php echo $doc->path; ?>" class="btn btn-link <?php echo ($doc->extension=='image/jpeg'?'magnific':'');?>" title="Download" target="_blank">View</a>
						...
						<div class="panel panel-default">
                            ...
                            <ul class="media-list" id="mgmtTeamcontainer">
                                <?php foreach($profile->supplierTeams as $item){ ?>
								<li class="media border-dotted" id="mgmtTeammember_<?php echo $item->id; ?>">
							...
							<ul class="media-list mb0" id="teamcontainer">
								<li class="media border-dotted">
									<div class="col-md-12 pl0 pr0 mt10 mb10" id="teamstatus">
								...
								<div class="media-list">
									<div class="media-body">
										...
										<div class="text-center" style="margin: 0px auto; width: 100%; display: inline-block;">
											<p class="media-heading f_s12 text-muted pb5 pt5">(<?php echo $sumref[ "totalratings"]; ?> Ratings)
											</p>
										</div>
									</div>
										...
										<li class="media border-dotted pl0 pr0">
											...
											<div class="media-body">
												...
												<div class="col-sm-12 pl0 pr0">
													...
													<h5 class="media-heading text-center text-default col-sm-3 mt-5 pl0 pr0">
														<?php echo ($sumref[ "q1"]);?>
													</h5>
												</div>
											</div>
							...
							<div id="comments" class="tab-pane" style="padding:0; padding-bottom: 10px; <?php echo (empty($allref)?'min-height: 70px;':'min-height: 360px;'); ?>">
                                ...
                                <div id="scrollbox4" style="min-height: 360px;">
									...
									<div class="media-list mt15 mb15 ml15 mr15">
										<div class="media-body">
											<div class="text-center">
												<img width="45px" height="45px" alt="" src="<?php echo (empty($project->clientProjects->clientProfiles->image)?(Yii::app()->theme->baseUrl."/image/avatar/avatar.png "):($project->clientProjects->clientProfiles->image)); ?>" class="img-circle">
											</div>
											<div class="text-center">
											...
											<div class="text-center" style="margin: 0px auto; width: 50%;">
												<p class="text-muted nm mt10 pt10" style="font-size: 10px;">
													<?php echo date( "m/d/Y",strtotime($ref->client->add_date)); ?>
												</p>
											</div>
										</div>
									</div>
									...
									<div class="col-md-12 pa15 pb0">
										...
										<div class="alert alert-dismissable alert-danger ml10 mb0">
							...
							<div class="panel-body pl0 pr0 pt0 pb0" style="border:none">
								...
								<div class="col-sm-12 pl0 pr0">
									...
									<div class="col-md-12 mt15 mb15">
										<div class="alert alert-dismissable alert-danger mb0">
											Client has not asked any question.
										</div>
									</div>

									<?php }else{ ?>

									<?php $index=0 ;$borderCount=0;
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content ">
			...
			<div class="form-group">
				...
				<?php if(empty($project->clientProjects->clientProjectsQuestions)){ ?>
				<div class="col-md-12 pl20">
					<div class="alert alert-dismissable alert-danger ml15">Client has not asked any custom questions!!
					</div>
				</div>
				<?php }else{ ?>
				...
				<div class="col-sm-12 ">
					<div class="col-sm-12 mb10">
						<label class="col-sm-4 control-label">Ques. <?php echo $question->question ; ?><span class="text-danger">*</span>
						</label>
						<div class="col-sm-8">
			...
			<div class="form-group">
				<div class="col-sm-12">
					<label class="col-sm-5 control-label">File attachment
						<span class="text-danger"></span>
					</label>
					<div class="col-sm-7">
			...
			<table class="table table-striped" id="uploadedfiles">
				...
				<div class="col-md-12 pl0">
					<div class="alert alert-dismissable alert-danger">
						...
						<!--<strong>Oh snap!</strong>-->No files Found !!
					</div>
				</div>
				<tbody>
					<?php }else{ ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header bgcolor-teal border-radius">
				<button type="button" class="close" data-dismiss="modal">×</button>
				<div class="pull-left ico-edit mr15 mt5" style="font-size:16px;"></div>
				<h4 class="semibold modal-title">Edit Price</h4>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-12">
					<label class="col-sm-4 control-label">Time &amp; Material
						<span class="text-danger">*</span>
					</label>
					<div class="col-sm-8">
						<span class="radio-inline custom-radio custom-radio-primary">
                            <input type="radio" name="SuppliersProjectsProposals[time_material]" id="customradio1" value="Time & Material" required="required" <?php echo ($project->time_material=="Time & Material"?"checked" : ""); ?>  >
                            <label for="customradio1">&nbsp;&nbsp;Time &amp; Material</label>
                        </span>
						<span class="radio-inline custom-radio custom-radio-primary">

                            <input type="radio" name="SuppliersProjectsProposals[time_material]" id="customradio3" value="Fixed" <?php echo ($project->time_material=="Fixed"?"checked" : ""); ?> <?php echo (empty($project->time_material)?"checked" : ""); ?> >
                            <label for="customradio3">&nbsp;&nbsp;Fixed</label>
                        </span>
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-8">
						<span class="radio-inline custom-radio custom-radio-primary price_input">
                            ...
                            <input type="radio" name="SuppliersProjectsProposals[billing_schedule]" id="SuppliersProjectsProposals_billing_schedule_01" value="Monthly" <?php echo ($project->billing_schedule=="Monthly"?"checked" : ""); ?> required>

                            <label for="SuppliersProjectsProposals_billing_schedule_01">&nbsp;&nbsp;Monthly</label>
                        </span>
						<span class="radio-inline custom-radio custom-radio-primary price_input">
                            <input type="radio" name="SuppliersProjectsProposals[billing_schedule]" id="SuppliersProjectsProposals_billing_schedule_Weekly" value="Weekly" <?php echo ($project->billing_schedule=="Weekly"?"checked" : ""); ?> >
                            <label for="SuppliersProjectsProposals_billing_schedule_Weekly">&nbsp;&nbsp;Weekly</label>
                        </span>
						<span class="radio-inline custom-radio custom-radio-primary price_input">
                            <input type="radio" name="SuppliersProjectsProposals[billing_schedule]" id="SuppliersProjectsProposals_billing_schedule_Biweekly" value="Biweekly" <?php echo ($project->billing_schedule=="Biweekly"?"checked" : ""); ?> >
						...
						<span class="radio-inline custom-radio custom-radio-primary">
                            <input type="radio" name="SuppliersProjectsProposals[billing_schedule]" id="SuppliersProjectsProposals_billing_schedule_custom" value="custom" <?php echo ($project->billing_schedule=="custom"?"checked" : ""); ?> >
                            <label for="SuppliersProjectsProposals_billing_schedule_custom">&nbsp;&nbsp;Custom</label>
                        </span>
						<div class="col-sm-12 mt10 pl0 pr0" id="sahil_input" <?php echo ($project->billing_schedule=="custom"?"" : "style='display:none'"); ?>>
							<?php echo $form->textField($project,'billing_schedule',array('placeholder'=>"Write custom billing schedule",'class'=>'form-control')); ?>
						</div>
			...
			<div class="form-group">
				<div class="col-sm-12">
					<label class="col-sm-4 control-label">Time Estimate
						<span class="text-danger">*</span>
					</label>
					<div class="col-sm-4">
						<div class="input-group">
			...
			<div class="modal-footer">
				...
				<button type="SUBMIT" class="btn btn-teal" id="btnpriceedit">Save Changes</button>
			</div>
			<?php $this->endWidget(); ?>
		</div>
		<!-- /.modal-content -->
					...
					$.ajax({
						...
						success: function (data) {
							...
							if (data.iserror) {
								...
								var newtr = "<tr class='doc_" + data.success[0].lastInsertedId + "'><td><span class='label label-success'>" + InkBlob.mimetype + "</span>" + InkBlob.filename + "</td>";
								newtr += "<td width='6%'>";
