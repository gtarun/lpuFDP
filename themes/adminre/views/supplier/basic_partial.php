<?php Yii::app()->clientScript->registerScript('helloscript','$("#countries_dropdown").selectize();$("#dynamicities").selectize();',CClientScript::POS_READY);?>
<!-- START Template Main -->
<section >
    ...
    <section class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="basic" class="profileSection panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-8">
								...
								<?php echo CHtml::dropDownList( 'country',$profile->cities->states_id,CHtml::listData(States::model()->findAllByAttributes(array("status"=>1)),'id', 'name'),array('class'=>"form-control",'id'=>"countries_dropdown", ));?>

								</div>
								<div class="col-sm-6">
								<?php echo CHtml::dropDownList( 'Suppliers[cities_id]', $profile->cities_id,CHtml::listData(Cities::model()->findAllByAttributes(array('states_id'=>$profile->cities->states_id)),'id', 'name'),array('class'=>"form-control",'id'=>"dynamicities"                                        ));?>
								</div>
							</div>
						</div>
                        <!--/Location -->
                            ...
                            <div class="col-sm-8" id="dynamicTeam">
                                ...
                                <div class="row mb10" id="member_<?php echo $item->attributes['id']; ?>">
                                    ...
                                    <div class="col-sm-2 mt5">
                                       <button type="button" class="bg-border-none" onclick="removeTeamMember('member_<?php echo $item->attributes['id']; ?>')"><i class="ico-minus2 text-default"></i></button>
                                    </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Q. What tools, languages, frameworks does your company specialize in?</label>
                            <div class="col-sm-8 mt15">
                                 <?php //print_r($skills); ?>
                                 <?php //print_r($selecetedSkills); ?>
                                 <?php //echo (in_array($skills[0]->id,$selecetedSkills)); ?>
                               <select id="SuppliersHasSkills_skills_id" class="form-control " placeholder="Select skills..." multiple name="SuppliersHasSkills[skills_id][]">
                            ...
                            <div class="">
                                ...
                                <div class="col-sm-8">
                                    <div class="table-responsive">
										...
										<small class="help-block text-danger">Please select the one closest to your average price.</small>
									   </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php echo $form->textField($profile,'pricing_details',array('placeholder'=>"Front end developer: $40/hour, Systems Architect: $75",'class'=>'form-control','required'=>'required',"data-parsley-maxlength"=>"250")); ?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo $form->textField($profile,'min_price',array('placeholder'=>"xx",'class'=>'form-control','required'=>'required',"data-parsley-type"=>"integer","data-parsley-maxlength"=>"10")); ?>
                                ...
                                <div class="col-sm-4 pl0 pr0 groupSD">
                                    ...
                                    <div class="panel-heading pl0 pr0">
										...
										<span class="checkbox custom-checkbox">
											<input type="checkbox" name="Services[]" <?php echo (in_array($service->id,$selecetedServices))?'checked':'';?> id="servicecheckbox<?php echo $service->id;?>" value="<?php echo $service->id;?>" <?php echo ($serviceRequired==0?"required":'');$serviceRequired++;?>/>
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Q. In which of these categories does your company have experience in? <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                                <!-- Group IO -->
                      ...
                      <label class="col-sm-4 control-label">Q. Can you give us a copy of the standard services agreement that you use with clients? <span class="text-danger"></span>
                        ...
                        <div class="panel-footer">
                            <div class="form-group no-border pt0 pb0">
                                ...
                                <div class="col-sm-8">
                                    <button type="submit" class="btn btn-teal pull-right" id="btn-form-basic">Save & Next</button>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
    	...
    	function hideNotification()
    	{
    		...
    		setTimeout(function() {
    			$(".signup_error_container").hide('blind', {}, 500); }, 2000);
    	}
</script>
...
<script type="text/javascript">
    ...
    function updateBudget(data)
    {
        ...
        console.log("update budget"+ newdata.priceTier);
...
<script type="text/javascript">
      $(document).ready(function(){
        ...
        filepicker.setKey("<?php echo $this->filpickerKey; ?>");
        filepicker.pick({
            mimetypes: ['image/*','text/plain','application/pdf','application/msword','application/vnd.openxmlformats-officedocument.wordprocessingml.document']
        },
            function(InkBlob){
                el.find(":input[type=text],:input[type=hidden]").val(InkBlob.url);      					console.log(InkBlob.url);                            									},
            function(FPError){
          		//alert("Error Uploading Files : " + FPError.toString());
                console.log(FPError.toString());
            }
