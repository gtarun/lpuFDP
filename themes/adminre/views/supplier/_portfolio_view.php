...
<?php $form=$this->beginWidget('CActiveForm', array('action'=>Yii::app()->createUrl('/supplier/profile'),'id'=>'portfolio-edit-supplier','enableClientValidation'=>true,'clientOptions'=>array('validateOnSubmit'=>true),'htmlOptions'=>array('class'=>"panel-default form-horizontal",'data-parsley-validate'=>'data-parsley-validate')));?>
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-7">
							<div class="input-group">
								<input type="text" readonly id="faketxtbox" <?php echo $form->hiddenField($portfolio,'cover',array('placeholder'=>"",'class'=>'form-control')); ?>
				...
				<div class="form-group">
					<div class="col-sm-12">
						...
						<div class="col-sm-7">
							<?php echo $form->textField($portfolio,'project_name',array('placeholder'=>"Amazon",'class'=>'form-control','required'=>'required',"data-parsley-maxlength"=>"30")); ?>
				...
				<div class="form-group">
					<div class="col-sm-12">
						...
						<div class="col-sm-7">
							<select id="SuppliersPortfolioHasSkillsEdit_id" class="form-control " placeholder="Select skills..." multiple name="SuppliersHasSkills[skills_id][]"  >
				...
				<div class="form-group">
					<div class="col-sm-12">
						...
						<div class="col-sm-7 ">
							...
							<?php echo $form->textField($portfolio,'estimate_price',array('placeholder'=>"",'class'=>'form-control','required'=>'required',"data-parsley-type"=>"integer","data-parsley-maxlength "=>"10")); ?>
                                </div>
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-7">
                            <div class="input-group">
								...
								<?php echo $form->textField($portfolio,'estimate_timelines',array('placeholder'=>"",'class'=>'form-control','required'=>'required',"data-parsley-maxlength "=>"10","data-parsley-type"=>"integer")); ?>
							</div>
						</div>
					</div>
				</div>
