		...
		<div class="col-lg-6">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<?php echo $form->textField($SupplierReferences,'project_name',array('placeholder'=>"",'class'=>'form-control','required'=>'required')); ?>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<small class="help-block">Note:<ul>
                        <li>Contact information provided here will not shared publicly on your profile.</li>
                        <li>It will purely be used by us to collect reviews from your past clients.</li></ul>
				...
				<div class="panel-footer">
					<div class="form-group no-border pt0 pb0">
						...
						<div class="col-sm-12  ">
							<button type="submit" class="btn btn-default pull-right" id="btnAddReference">Add +</button>
					...
					<table class="table table-bordered table-hover" id="dynamictr">
						...
						<tbody>
							...
							<tr class="<?php echo $reference->status==0 ? '' :  'active'; ?> border_bottom" id="ref_<?php echo $reference->id; ?>">
								...
								<td >
									<?php echo $reference->project_name; ?></td>
								<td width="25%">
								...
								<td class="text-center" width="15%">
									...
									<div class="toolbar">
										<div class="btn-group">
											...
											<?php }else{ ?>
											<?php $img= $reference->client->image;
													if(empty($img)){$img="avatar.png";} ?>
											<a title="View Recommendation" class="btn btn-link text-success" href="#" data-toggle="modal" id="editportfolio"><i class="ico-search" onclick='viewRecomendation(<?php echo json_encode($reference->attributes); ?>,<?php echo json_encode($reference->client->image); ?>)'></i></a>
                ...
                <div class="panel-footer">
					<div class="form-group no-border">
						...
						<div class="col-sm-12  pr0">
							<button type="submit" class="btn btn-teal pull-right" id="btnPastNext">Next</button>
			...
			var xhr = $.ajax({
				...
				success: function(data){
						...
						else
						{
							...
							$(".pastclientcount").html(parseInt($(".pastclientcount").text())+1)
                           $(".pastclientcount").data("original-title",((parseInt($(".pastclientcount").text())+1)+" Past Clients Added"));
							...
							newtr+="<td>"+$("#SuppliersHasReferences_project_name").val()+"</td>";
