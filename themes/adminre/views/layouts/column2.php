            ...
            <section class="content slimscroll">
                ...
                <ul id="nav" class="topmenu">
                   <!-- <li class="menuheader">MAIN MENU</li>-->
                                    ...
                                    <li <?php if($_GET['r']=='admin') {?> class="active" <?php } ?>>
                    ...
                    <li>
                        ...
                        <?php if($_GET['r']=='admin/users/admin'||$_GET['r']=='admin/clientProfiles/admin'||$_GET['r']=='admin/clientProjects/admin'||$_GET['r']=='admin/users/create'||$_GET['r']=='admin/clientProfiles/create'||$_GET['r']=='admin/clientProjects/create')
						{ ?>
                        ...
                        <?php }?>
                            ...
                            <li>
                             <a href="javascript:void(0);" data-toggle="submenu" data-target="#payment-1-1" data-parent="#payment">
                            <span class="figure"><i class="ico-dollar"></i></span>
                            <span class="text">User Management</span>
                            <span class="arrow"></span>
                        </a>
                         <!-- START 3rd Level Menu -->
                        <?php if($_GET['r']=='admin/users/admin'||$_GET['r']=='admin/users/create') {?>
                        <ul id="payment-1-1" class="submenu collapse in">
			         	<?php } else {?>
                        <ul id="payment-1-1" class="submenu collapse">
                        <?php } ?>
                         <li <?php if($_GET['r']=='admin/users/create') {?> class="active" <?php } ?>>
                            	<?php echo CHtml::link('<span class="figure"></span>
                            <span class="text">Create Users</span>', array('/admin/users/create'));

                            ?></li>
                        <li <?php if($_GET['r']=='admin/users/admin') {?> class="active" <?php } ?>>
                          <?php echo CHtml::link('<span class="figure"></span>
                         ...
                         <!-- START 3rd Level Menu -->
                        <?php if($_GET['r']=='admin/clientProfiles/admin'||$_GET['r']=='admin/clientProfiles/create') {?>
                        <ul id="payment-1-2" class="submenu collapse in">
			         	<?php } else {?>
                        <ul id="payment-1-2" class="submenu collapse">
                        <?php } ?>

                        	<li <?php if($_GET['r']=='admin/clientProfiles/create') {?> class="active" <?php } ?>>
                            	<?php echo CHtml::link('<span class="figure"></span>
                            <span class="text">Create Client Profiles</span>', array('/admin/clientProfiles/create'));

                            ?></li>
                          <li <?php if($_GET['r']=='admin/clientProfiles/admin') {?> class="active" <?php } ?>>
                          <?php echo CHtml::link('<span class="figure"></span>
                         ...
                         <!-- START 3rd Level Menu -->
                        <?php if($_GET['r']=='admin/clientProjects/admin') {?>
                        <ul id="payment-1-3" class="submenu collapse in">
			         	<?php } else {?>
                        <ul id="payment-1-3" class="submenu collapse">
                        <?php } ?>

                          <li <?php if($_GET['r']=='admin/clientProjects/admin') {?> class="active" <?php } ?>>
                          <?php echo CHtml::link('<span class="figure"></span>
                ...
                <li>
                        ...
                        <!-- START 2nd Level Menu -->
   <?php if($_GET['r']=='admin/suppliers/admin'||$_GET['r']=='admin/suppliersProjectsProposals/admin'||$_GET['r']=='admin/developerTypes/admin'||$_GET['r']=='admin/suppliers/create'||$_GET['r']=='admin/suppliersProjectsProposals/create'||$_GET['r']=='admin/developerTypes/create')
						{ ?>
                        ...
                        <?php }?>
                         ...
                         <!-- START 3rd Level Menu -->
                       <?php if($_GET['r']=='admin/suppliers/admin'||$_GET['r']=='admin/suppliers/create') {?>
