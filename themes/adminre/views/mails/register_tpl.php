...
<div class="grey">
	...
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
			Welcome to VenturePact! We are here to help you find the right software development company for your needs. Please click on the link below to verify your email address.<br/><br/>
		</td>
	</tr>
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
    ...
    <tr>
    <td>
    Feel free to schedule a call if you need any assistance. <br/><br/>
    </td>
    </tr>
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
