...
<div class="grey">
	...
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
			...
			The client has decided to go with another service provider for this project. Feel free to inquire directly with the client as to why he thought your company was not a good fit.
			<br /><br/>
			We wish you luck on the next project.
			<br /><br/>
