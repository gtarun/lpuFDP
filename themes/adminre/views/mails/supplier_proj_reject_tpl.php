...
<div class="grey">
	...
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
		We were wondering why <?php echo $data['project']; ?> was not a good fit for you. Do let us know, so that we can adjust our matching parameters for the future. Feel free to reply to this email with your answer.
		<br/><br/>
