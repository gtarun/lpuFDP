...
<section class="container-fluid">
    ...
    <div class="page-header page-header-block">
        ...
        <?php if(Yii::app()->user->profile->is_complete==0){ ?>
        <div class="row">
            <div class="col-sm-8">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="toolbar">
                            ...
                            <?php if(!empty($questions)){ ?>
                            <?php foreach($questions as $q){ ?>
                            <a href="#" class="btn btn-default" id="q_<?php echo $q->id; ?>" title="love this collection">
                                <?php echo $q->id ;?><i class=""></i>
                            </a>
        ...
        <div class="alert alert-info fade in">
            ...
            <h4 class="semibold">Thanks You!</h4>
            <p class="mb10">You have already attempted this test get your certificate.</p>
            <a type="button" class="btn btn-info" href="<?php echo CController::createUrl('/users/certificate'); ?>">Take this action</a>
        </div>
        <?php } ?>
    </div>
    <!--/ Page header -->
